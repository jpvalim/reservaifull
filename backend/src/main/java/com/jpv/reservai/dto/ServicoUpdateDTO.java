...
public class ServicoUpdateDTO{
	...
	public ServicoUpdateDTO(Long codigo, String descricao, Double preco, String descricaoUnidade, Long tempoMinutos, Long codAtendente) {
		this.codigo = codigo;
	...
	public ServicoUpdateDTO(Servico obj) {
